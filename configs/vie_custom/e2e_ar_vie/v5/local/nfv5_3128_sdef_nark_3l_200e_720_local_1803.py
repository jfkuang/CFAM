...
_base_ = [
    '../../../_base_/vie_datasets/nfv5_3128_ar_local_1803.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e/nfv5_3128/dict.json',
        class_file='/home/whua/dataset/ie_e2e/nfv5_3128/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
load_from = '/home/whua/logs/ie_ocr_weights/ocr_pretrain_eng_full_default_dp02_rc_rr_cj_blsh_lr4e4_dpp02_epoch_6.pth'
resume_from = None
workflow = [('train', 1)]
