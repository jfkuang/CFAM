...
_base_ = [
    '../../../_base_/vie_datasets/nfv5_3125_ar_local_1803.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e/nfv5_3125/dict.json',
        class_file='/home/whua/dataset/ie_e2e/nfv5_3125/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
