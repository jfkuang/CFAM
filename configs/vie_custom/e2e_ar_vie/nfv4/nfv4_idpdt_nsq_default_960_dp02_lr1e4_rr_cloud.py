...
_base_ = [
    '../../_base_/vie_datasets/nfv4_ar_cloud.py',
    '../../_base_/e2e_pipelines/vie_manner_pipeline_aug_rr_960.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/apdcephfs/share_887471/interns/v_willwhua/dataset/ie_e2e/nfv4/dict.json',
        class_file='/apdcephfs/share_887471/interns/v_willwhua/dataset/ie_e2e/nfv4/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
