...
_base_ = [
    '../../_base_/vie_datasets/sroie_ar_local.py',
    '../../_base_/e2e_pipelines/vie_manner_pipeline_1280_gt_ocr.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/data/whua/dataset/ie_e2e/sroie/e2e_format/dict.json',
        class_file='/data/whua/dataset/ie_e2e/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
