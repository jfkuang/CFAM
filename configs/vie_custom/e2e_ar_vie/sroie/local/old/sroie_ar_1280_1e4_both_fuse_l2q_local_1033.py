...
_base_ = [
    '../../../_base_/vie_datasets/sroie_ar_local_1033.py',
...
# det_module['backbone']['plugins'] = [
#     dict(cfg=dict(type='GCAContextBlock',
#                   ratio=0.0625,
#                   headers=1,
#                   att_scale=False,
...
# ]
# det_module['backbone']['type'] = 'mmdet.CustomResNet'
# det_module['backbone']['block_to_insert_plugin'] = [
#             [False, False, False],
...
model = dict(
    ...
    neck=dict(
        feature_fuser=dict(
            feat_num_in=4, in_channels=256, out_channels=128
        ),
        roi_extractor=dict(
    ...
    ext_head=dict(
        ...
        rec_cfg=dict(
            ...
            rec_decoder_args=dict(
                ...
                size=512,
                dropout=0.,
                layout_to_query=True,
                layout_to_memory=False,
                context_to_query=False
            ),
            rec_layer_num=5,
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/share/whua/dataset/ie_e2e/sroie/e2e_format/dict.json',
        class_file='/share/whua/dataset/ie_e2e/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
