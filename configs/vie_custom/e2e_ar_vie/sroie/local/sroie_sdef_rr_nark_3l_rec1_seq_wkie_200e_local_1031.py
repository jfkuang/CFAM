...
_base_ = [
    '../../../_base_/vie_datasets/sroie_screen_ar_local_1031.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/mnt/whua/logs/ie_data/sroie/dict.json',
        class_file='/mnt/whua/logs/ie_data/sroie/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
