...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=False,
        show_entity=False,
        dict_file='/data3/jfkuang/data/sroie/e2e_format/dict.json',
        class_file='/data3/jfkuang/data/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
load_from = '/data3/jfkuang/weights/sroie_FORMAL_3L_screen_ft_default_dp02_rr_3l_lr2e4_bs4_epoch_570.pth'
resume_from = None
workflow = [('train', 1)]
