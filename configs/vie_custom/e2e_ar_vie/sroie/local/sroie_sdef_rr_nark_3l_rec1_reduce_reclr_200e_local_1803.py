...
_base_ = [
    '../../../_base_/vie_datasets/sroie_screen_ar_local_1803.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e/sroie/e2e_format/dict.json',
        class_file='/home/whua/dataset/ie_e2e/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
optimizer = dict(type='Adam', lr=2e-5,
                 paramwise_cfg=dict(
                     custom_keys={'spatial_embedding': dict(lr_mult=10.0),
                                  'ext_head.kie_norm': dict(lr_mult=10.0),
                                  'ext_head.rec_kie_layer': dict(lr_mult=10.0),
                                  'ext_head.kie_fc': dict(lr_mult=10.0),
                                  'ext_head.kie_decoder': dict(lr_mult=10.0)}
                 ))
