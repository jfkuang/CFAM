...
_base_ = [
    '../../../_base_/vie_datasets/local/nfv3_ar_local_1033.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e/nfv3/e2e_format/dict.json',
        class_file='/home/whua/dataset/ie_e2e/nfv3/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
