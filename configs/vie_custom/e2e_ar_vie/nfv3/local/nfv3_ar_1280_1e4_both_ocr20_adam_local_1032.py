...
_base_ = [
    '../../../_base_/vie_datasets/local/nfv3_ar_local_1032.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/datasets/ie_e2e_format/nfv3/dict.json',
        class_file='/home/whua/datasets/ie_e2e_format/nfv3/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
