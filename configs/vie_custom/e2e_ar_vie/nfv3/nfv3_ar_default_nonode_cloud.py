...
_base_ = [
    '../../_base_/vie_datasets/nfv3_ar_cloud.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/apdcephfs/share_887471/common/whua/dataset/ie_e2e/nfv3/e2e_format/dict.json',
        class_file='/apdcephfs/share_887471/common/whua/dataset/ie_e2e/nfv3/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
