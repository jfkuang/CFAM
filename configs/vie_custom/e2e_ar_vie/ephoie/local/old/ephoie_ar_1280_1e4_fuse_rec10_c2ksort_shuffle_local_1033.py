...
_base_ = [
    '../../../_base_/vie_datasets/local/ephoie_ar_local_1033.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/share/whua/dataset/ie_e2e/ephoie/e2e_format/dict.json',
        class_file='/share/whua/dataset/ie_e2e/ephoie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
