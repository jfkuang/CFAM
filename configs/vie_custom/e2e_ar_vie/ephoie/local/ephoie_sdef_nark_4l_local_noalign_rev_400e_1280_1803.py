...
_base_ = [
    '../../../_base_/vie_datasets/local/ephoie_ar_local_1803.py',
    '../../../_base_/e2e_pipelines/vie_manner_pipeline_aug_1280.py'
]
...
det_module['train_cfg']['rpn_proposal']['nms']['iou_threshold'] = 0.75
det_module['test_cfg']['rpn']['nms']['iou_threshold'] = 0.45
det_module['test_cfg']['rcnn']['nms']['iou_threshold'] = 0.3
det_module['rpn_head']['anchor_generator']['ratios'] = [0.03, 0.06, 0.1, 0.16, 0.25, 0.17, 0.44, 1.13, 2.9, 7.46]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e/ephoie/e2e_format/dict.json',
        class_file='/home/whua/dataset/ie_e2e/ephoie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
train_list = {{_base_.test_list}}
test_list = {{_base_.train_list}}
...
evaluation = dict(interval=30, metric='e2e-hmean')
