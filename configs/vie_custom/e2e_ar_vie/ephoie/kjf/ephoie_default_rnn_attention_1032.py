...
'''
@Project ：ie_e2e 
@File    ：ephoie_default_rnn_attention_1062.py.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
_base_ = [
    '../../../_base_/vie_datasets/local/ephoie_ar_local_1032_kjf.py',
    '../../../_base_/e2e_pipelines/vie_manner_pipeline_aug_norot_1280_kjf.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        class_file='/home/jfkuang/data/ephoie_e2e_format/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
