...
_base_ = [
    '../../_base_/vie_datasets/ephoie_ar_sort_cloud.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/apdcephfs/share_887471/common/whua/dataset/ie_e2e/ephoie/e2e_format/dict.json',
        class_file='/apdcephfs/share_887471/common/whua/dataset/ie_e2e/ephoie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
