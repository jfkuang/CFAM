...
'''
@Project ：ie_e2e 
@File    ：cord_baseline_1280_200e_1803.py
@IDE     ：PyCharm 
@Author  ：jfkuang
@Date    ：2022/10/9 19:11 
'''
...
_base_ = [
    '../../_base_/vie_datasets/cord_ar_local_1032.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e_dataset/cord/e2e_format/dict.json',
        class_file='/home/whua/dataset/ie_e2e_dataset/cord/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
resume_from = None
# resume_from = "/home/jfkuang/logs/ie_e2e_log/ours_cord_600e/latest.pth"
workflow = [('train', 1)]
