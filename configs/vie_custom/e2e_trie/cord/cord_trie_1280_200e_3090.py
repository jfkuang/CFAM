...
'''
@Project ：ie_e2e 
@File    ：cord_trie_1280_200e_3090.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
_base_ = [
    '../../_base_/vie_datasets/cord_3090.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/data2/jfkuang/data/cord/e2e_format/dict.json',
        class_file='/data2/jfkuang/data/cord/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
load_from = '/data2/jfkuang/weights/ocr_pretrain_eng_full_default_dp02_rc_rr_cj_blsh_lr4e4_dpp02_epoch_6.pth'
resume_from = None
workflow = [('train', 1)]
