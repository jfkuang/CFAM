...
_base_ = [
    '../../../_base_/vie_datasets/local/ephoie_ar_local_1062.py',
    '../../../_base_/e2e_pipelines/vie_manner_pipeline_aug_norot_GT_1280.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e_dataset/ephoie/e2e_format/dict.json',
        class_file='/home/whua/dataset/ie_e2e_dataset/ephoie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
