...
_base_ = [
    '../../../_base_/vie_datasets/nfv5_2200_3128_ar_local_1062.py',
    '../../../_base_/e2e_pipelines/vie_manner_pipeline_aug_norot_720.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/whua/dataset/ie_e2e_dataset/nfv5_2200_3128/dict.json',
        class_file='/home/whua/dataset/ie_e2e_dataset/nfv5_2200_3128/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
