...
'''
@Project ：ie_e2e 
@File    ：sroie_sc_sdef_norot_3l_local_3090.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
_base_ = [
    '../../../_base_/vie_datasets/sroie_3090.py',
    '../../../_base_/e2e_pipelines/vie_manner_pipeline_aug_rr_norot_1280.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/data2/jfkuang/data/sroie/dict.json',
        class_file='/data2/jfkuang/data/sroie/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
...
load_from = '/data2/jfkuang/weights/sroie_FORMAL_3L_screen_ft_default_dp02_rr_3l_lr2e4_bs4_epoch_570.pth'
resume_from = None
workflow = [('train', 1)]
