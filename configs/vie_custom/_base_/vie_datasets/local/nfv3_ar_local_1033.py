...
data_root = '/home/whua/dataset/ie_e2e/nfv3/e2e_format'
...
train = dict(
    type=dataset_type,
    ann_file=f'{data_root}/train_even.txt',
    loader=loader,
...
test = dict(
    ...
    # ann_file=f'{data_root}/test_split_google.txt',
    # ann_file=f'{data_root}/test_split_nf.txt',
    ann_file=f'{data_root}/test_even.txt',
    loader=loader,
    dict_file=f'{data_root}/dict.json',
    img_prefix=data_root,
    pipeline=None,
