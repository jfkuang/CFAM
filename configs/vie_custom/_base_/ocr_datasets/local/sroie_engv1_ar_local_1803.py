...
data_root = '/home/whua/dataset/ie_e2e/sroie/e2e_format'
...
train_eng_v1 = dict(
    type=dataset_type,
    ann_file=f'/home/whua/dataset/ocr_pretrain/custom_eng_v1/merged/annotation.txt',
    loader=loader,
    dict_file=f'{data_root}/dict.json',
    img_prefix='/home/whua/dataset/ocr_pretrain/custom_eng_v1/merged',
    pipeline=None,
    test_mode=False,
    class_file=f'{data_root}/class_list.json',
    data_type='ocr',
