...
data_root_sroie = '/apdcephfs/share_887471/interns/v_willwhua/dataset/ie_e2e/sroie/e2e_format'
...
train_sroie = dict(
    type=dataset_type,
    ann_file=f'{data_root_sroie}/train_update.txt',
    loader=loader,
    dict_file=f'{data_root}/dict.json',
...
train_list = [train_sroie, train, train_sroie, train_sroie]
