...
'''
@Project ：ie_e2e 
@File    ：ocr_pretrain_pipeline_aug_1280_1032_vis_kjf.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
max_scale, min_scale = 1280, 1280

#1. add det 2. change rotate 3. change random resize 4. change roi-size
...
train_pipeline = [
    ...
    #vis
    dict(type='CustomVisualizer', vis_mask=False, vis_text=False, vis_entity=False,
         vis_dir='/home/jfkuang/logs/ie_e2e_log/ephoie_baseline_noalign_vis/', vis_num_limit=1183),
