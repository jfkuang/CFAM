...
max_scale, min_scale = 1728, 1728
max_scale_test, min_scale_test = 1280, 1280
...
train_pipeline = [
    ...
    #      vis_dir='/mnt/whua/ie_e2e_log/e2e_openmm_visualization', vis_num_limit=10),
...
test_pipeline = [
    ...
    # may be replace to 'ScaleAspectJitter'
    dict(type='CustomResize',
         img_scale=(max_scale_test, min_scale_test), keep_ratio=True, multiscale_mode='range'),
    dict(type='RandomFlip', flip_ratio=0.),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='Pad', size_divisor=32),
    dict(type='E2EFormatBundle'),
