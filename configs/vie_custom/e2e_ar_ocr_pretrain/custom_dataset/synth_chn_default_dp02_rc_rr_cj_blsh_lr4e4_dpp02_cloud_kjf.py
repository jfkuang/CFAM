...
'''
@Project ：ie_e2e 
@File    ：synth_chn_default_dp02_rc_rr_cj_blsh_lr4e4_dpp02_cloud_kjf.py
@IDE     ：PyCharm 
@Author  ：jfkuang
@Date    ：2022/6/4 17:05 
'''
...
_base_ = [
    '../../_base_/ocr_datasets/synth_chn_ar_cloud_kjf.py',
    '../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_rc_cj_blsh_1280_kjf_1803.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_entity=True,
        #1032
        # dict_file='/data/jfkuang/syntext/custom_dict.json',
        #1803
        dict_file='/home/jfkuang/data/syntext/custom_dict.json',
        class_file=None,
        auto_reg=True
    ),
    pretrain=None,
