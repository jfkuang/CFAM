...
_base_ = [
    '../../_base_/ocr_datasets/synth_chn_ar_cloud.py',
    '../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_rc_rr_cj_blsh_1280.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/apdcephfs/share_887471/interns/v_willwhua/dataset/ocr_benchmark/synth_chinese/data/syntext/custom_dict.json',
        class_file=None,
        auto_reg=True
    ),
    pretrain=None,
