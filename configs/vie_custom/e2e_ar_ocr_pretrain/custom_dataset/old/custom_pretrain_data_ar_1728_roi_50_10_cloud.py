...
_base_ = [
    '../_base_/ocr_datasets/custom_pretrain_data_ar_cloud.py',
    '../_base_/e2e_pipelines/ocr_pretrain_pipeline_1728.py'
]
...
model = dict(
    ...
    neck=dict(
        roi_extractor=dict(
            ...
            roi_layer=dict(type='RoIAlign', output_size=(10, 50), sampling_ratio=0),
            out_channels=256,
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/apdcephfs/share_887471/common/whua/dataset/ie_e2e/custom_pretrain/merged/dict.json',
        class_file=None,
        auto_reg=True
    ),
    pretrain=None,
...
evaluation = dict(interval=1, metric='e2e-hmean')
