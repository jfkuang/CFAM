...
_base_ = [
    '../../_base_/ocr_datasets/sroie_screen_ar_cloud.py',
    '../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_rr_1280.py'
]
...
model = dict(
    ...
    neck=dict(
        ...
        roi_extractor=dict(
            ...
            roi_layer=dict(type='RoIAlign', output_size=(12, 60), sampling_ratio=0),
            out_channels=512,
            featmap_strides=[4, ]),
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=False,
        dict_file='/apdcephfs/share_887471/interns/v_willwhua/dataset/ie_e2e/sroie/e2e_format/dict.json',
        class_file='/apdcephfs/share_887471/interns/v_willwhua/dataset/ie_e2e/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
