...
_base_ = [
    '../../../_base_/ocr_datasets/local/sroie_ar_local_1028.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/data/whua/ie_e2e/sroie/e2e_format/dict.json',
        class_file='/data/whua/ie_e2e/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
