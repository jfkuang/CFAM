...
_base_ = [
    '../../../_base_/ocr_datasets/local/sroie_ar_local_1032_kjf.py',
    '../../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_1280_kjf.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/home/jfkuang/data/ie_e2e_format/sroie/e2e_format/dict.json',
        class_file='/home/jfkuang/data/ie_e2e_format/sroie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
