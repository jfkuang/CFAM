...
_base_ = [
    '../../../_base_/ocr_datasets/local/sroie_ar_local_screen_1062.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=False,
        dict_file='/home/whua/dataset/ie_e2e_dataset/sroie/dict.json',
        class_file='/home/whua/dataset/ie_e2e_dataset/sroie/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
