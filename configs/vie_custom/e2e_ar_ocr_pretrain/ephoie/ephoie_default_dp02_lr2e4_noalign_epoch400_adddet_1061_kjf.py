...
'''
@Project ：ie_e2e 
@File    ：ephoie_default_dp02_lr2e4_noalign_epoch400_adddet_1061_kjf.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
_base_ = [
    ...
    '../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_1280_1061_kjf.py'
]
...
# box to polygon
# det_module['text_repr_type'] = 'poly'
