...
'''
@Project ：ie_e2e 
@File    ：ephoie_default_dp02_lr2e4_noalign_epoch400_adddet_rr_1061_kjf.py
@IDE     ：PyCharm 
@Author  ：jfkuang
@Date    ：2022/6/18 14:21 
'''
...
_base_ = [
    '../../_base_/ocr_datasets/local/ephoie_local_1061_kjf.py',
    '../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_rr_1280_1061_kjf.py'
]
...
#box to polygon
#det_modult['text_repr_type'] = 'poly'
