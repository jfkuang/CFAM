...
'''
@Project ：ie_e2e 
@File    ：ephoie_default_dp02_lr2e4_roi_1032_kjf.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
'''
@Project ：ie_e2e 
@File    ：ephoie_default_dp02_lr2e4_rr_1032_kjf.py
@IDE     ：PyCharm 
@Author  ：jfkuang
@Date    ：2022/6/9 19:56 
'''
...
_base_ = [
    '../../_base_/ocr_datasets/local/ephoie_local_1032_kjf.py',
    '../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_1280_1032_kjf.py'
]
...
model = dict(
    ...
    neck=dict(
        ...
        roi_extractor=dict(
            ...
            #change (10,40)->(10,20)
            roi_layer=dict(type='RoIAlign', output_size=(10, 20), sampling_ratio=0),
            out_channels=512,
            featmap_strides=[4, ]),
