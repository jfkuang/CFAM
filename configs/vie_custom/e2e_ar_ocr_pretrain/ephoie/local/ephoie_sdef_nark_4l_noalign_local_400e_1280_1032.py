...
_base_ = [
    '../../../_base_/ocr_datasets/local/ephoie_ar_local_1032.py',
    '../../../_base_/e2e_pipelines/ocr_pretrain_pipeline_aug_1280.py'
]
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=False,
        dict_file='/home/whua/datasets/ie_e2e_format/ephoie/e2e_format/dict.json',
        class_file='/home/whua/datasets/ie_e2e_format/ephoie/e2e_format/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
