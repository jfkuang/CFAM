...
_base_ = [
    '../../../_base_/ocr_datasets/local/nfv5_2200_ar_local_1032.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=False,
        dict_file='/home/whua/datasets/ie_e2e_format/nfv5_2200/dict.json',
        class_file='/home/whua/datasets/ie_e2e_format/nfv5_2200/class_list.json',
        auto_reg=True
    ),
    pretrain=None,
    init_cfg=None,
