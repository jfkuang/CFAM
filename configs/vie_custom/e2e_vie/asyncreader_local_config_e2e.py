...
model = dict(
    ...
    vis_cfg=dict(
        ...
        show_text=True,
        show_entity=True,
        dict_file='/data/whua/dataset/ie_e2e/nfv1/ie_e2e_data/mm_format/table/dict.json',
        class_file='/data/whua/dataset/ie_e2e/nfv1/ie_e2e_data/mm_format/table/class_list.json'
    ),
    pretrain=None,
    init_cfg=None,
    train_cfg=None,
    test_cfg=None,
    part_pretrain=dict(EXT='/data/whua/ie_e2e_weights/vitstr_small_patch16_224.pth'),
    # part_pretrain=None,
    model_type='VIE')
