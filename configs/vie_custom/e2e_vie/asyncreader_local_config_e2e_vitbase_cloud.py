...
_base_ = [
    '../_base_/vie_datasets/nutrition_fact_v1_cloud.py',
...
model = dict(
    ...
    vis_cfg=dict(
        ...
        class_file='/apdcephfs/share_887471/common/whua/dataset/ie_e2e/ie_e2e_data/mm_format/table/class_list.json',
    ),
    pretrain=None,
    init_cfg=None,
    train_cfg=None,
    test_cfg=None,
    part_pretrain=dict(EXT='/apdcephfs/share_887471/common/whua/logs/ie_e2e_weights/vitstr_base_patch16_224.pth'),
    model_type='VIE')
