...
'''
@Project ：ie_e2e 
@File    ：ar_reader_nar_ie_0726_kvc_head.py
@IDE     ：PyCharm 
@Author  ：jfkuang
...
class AutoRegReaderNARIE0726_kvc_head(BaseRecognizer):
    def __init__(self,
                 rec_cfg,
                 loss=None,
                 use_ins_mask=False,
...
m
    ...
    def extract_feat(self, imgs):
        super(AutoRegReaderNARIE0726_kvc_head, self).extract_feat(imgs)