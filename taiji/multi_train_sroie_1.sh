...
# 0608_trie_ar_sroie_ft_sroie_default_rr_bs4_0
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port=29500 \
${WORKSPACE}/code/ie_e2e/tools/train.py ${WORKSPACE}/code/ie_e2e/configs/vie_custom/e2e_trie/sroie/sroie_sc_sdef_cloud.py \
--work-dir=${WORKSPACE_SELF}/logs/ie_trie_log/sroie_ft_sroie_trie_def_rr_bs4 --launcher pytorch --gpus 4 \
